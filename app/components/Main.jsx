        ...
        >
          <div className=" absolute w-full p-2 z-10">
            <div className="flex justify-between items-center ">
              ...
              <p className="text-neutral-500 text-xs ">Quilmes, Argentina</p>
            </div>
          ...
          <motion.img
            ...
            src={theme == "dark" ? "/map.webp" : "/map.webp"}
            alt=""
          />
        </motion.div>
          ...
          <div className=" absolute w-full p-2">
            ...
            <div className="">
              <p className="text-xs font-semibold max-sm:mt-16 sm:mt-4  ">
                Available to work <br /> Need a website? hit me up <br />{" "}
                to increase ur sales 🦾
              </p>
              ...
              <button className="text-xs flex w-full items-center justify-between border dark:border-neutral-600 border-neutral-400/60  mt-3 rounded-full p-1 px-2 dark:bg-neutral-700/40 sm:w-full">
                <a href="https://api.whatsapp.com/send?phone=541140243724">Contact Me</a>
                <PiArrowUpRight />
              </button>
            </div>
          </div>
        ...
        >
          <div className=" absolute w-full p-2 z-10">
            <div className="flex justify-between items-center ">
              ...
              <p className="text-neutral-500 text-xs ">Mayron Valerga</p>
            </div>
            <div className="w-full h-[0.9px] dark:bg-neutral-600 bg-neutral-400/60 mt-1 top-7  " />
          </div>
          ...
          I am Mayron Valerga, an adventurous website developer located in the vibrant city of Buenos Aires. With a keen eye for aesthetics, a passion for innovation and a drive for designs that would leave a
lasting impact on your business. We will collaborate and make your company look mega professional!
            </p>
          </div>
        </motion.div>
        ...
        <div className=" absolute w-full p-2 z-10">
            <div className="flex justify-between items-center ">
              ...
              <p className="text-neutral-500 text-xs "> <Link href={"../proyectos"}>Show more</Link></p>            
            </div>
            <div className="w-full h-[0.9px] dark:bg-neutral-600 bg-neutral-400/60 mt-1 top-7  " />
          </div>
        ...
        <div className="dark:bg-[#1E1E1E] bg-white border dark:border-neutral-600 border-neutral-400/60 shadow-xl rounded-lg min-h-[50px] col-span-2  relative">
          ...
          <div className="mt-14 mb-4">
            <div className="flex justify-center gap-x-2 px-2">
              <Tooltip showArrow={true} content="Whatsapp" color="#161616">
                <Link
                  href={"https://api.whatsapp.com/send?phone=541140243724"}
              ...
              <Tooltip showArrow={true} content="GitHub" color="#161616">
                <Link
                  href={"https://github.com/Mayron123"}
                  className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                >
              ...
              <Tooltip showArrow={true} content="E-mail" color="#161616">
                <Link
                  href={"mailto:sarkeisen123@gmail.com"}
                  className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                >
        ...
        >
          <div>
            ...
            <div className="flex items-center gap-x-2 mt-7">
              ...
              <div className="">
                <p className="text-xs">Mayron Valerga</p>
